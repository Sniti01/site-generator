 ...
 *      Узел с классом оглавления — оглавление, только если внутри не меньше
 *      `ссылок_на_разделы_от` ссылок на разделы этой же страницы (П71 п. 4,
 *      П72): навигация по главам многостраничного руководства — не оглавление.
...
function selftest(root) {
  ...
  check('правила: слепок структуры', 'f88fcacb4a2eb0fc', slepok, 'пересчитать слепок — сознательно, вместе с перемером');
