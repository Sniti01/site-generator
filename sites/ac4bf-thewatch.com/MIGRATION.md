...
| Файл | Размер | `scrollY` |
|---|---|---|
| `baseline-desktop-layer-jerozolima-1440x900.png` | 1440×900 | 892 |
| `baseline-desktop-layer-wlochy-1440x900.png` | 1440×900 | 1818 |
| `baseline-desktop-layer-londyn-1440x900.png` | 1440×900 | 6006 |

**`scrollY` — литерал, а не «где встало»:** прокрутка выполняется ровно
к записанному числу, и совпадение `window.scrollY` с ним проверяется до
съёмки. Сдвиг геометрии выше слоя обязан проявиться расхождением кадра,
а не молча уехать вместе с новым `offsetTop`. Состав, роли и порядок
съёмки — `_baseline/README.md`.
