...
artFocus: 60% 50%
lead: >-
  Nine years after the second game, Max is a hard-drinking bodyguard for a
  rich family in São Paulo. Rockstar made this one, for PS3, Xbox 360 and PC
  in 2012 — here is what to know before you play it.
primary:
  href: "#where-to-play"
  label: Where to play it today
secondary:
  href: /max-payne-3/guide/
  label: The walkthrough
rows:
  - id: story
    year: The story
    title: Max in São Paulo
    meta: The setup, without the twists
    art: mp3-k15
    body:
      - >-
  ...
  - id: release
    year: Release
    title: PS3, Xbox 360, PC and Mac
    meta: North American dates, PAL ones in brackets
    band: true
    body:
      - >-
        ...
        June 20, 2013, running on Rockstar’s RAGE engine with Euphoria driving
  ...
  - id: where-to-play
    ...
    body:
      - >-
        ...
        launcher may need the touchscreen or on-screen keyboard, and the
        native resolution has to be set by hand.
      - >-
        On Xbox, as of September 2026, the store lists it for Xbox One and
        Xbox Series X|S; the game has been backward compatible there since
        November 15, 2021. On PlayStation it remains a PS3 game: Wikipedia’s
        list of its platforms, checked in September 2026, has no PS4 or PS5
        version, and no remaster has been announced.
  - id: rating
    year: Rating
    title: Rated M for Mature
    meta: The ESRB descriptors and what they refer to
    band: true
    body:
      - >-
        The ESRB rates Max Payne 3 M (Mature 17+) on every platform it lists —
        PC, PS3, Xbox 360 and Mac — with six content descriptors: intense
        violence, blood and gore, strong language, partial nudity, strong
  ...
  - id: gameplay
    ...
    meta: How it plays, in short
    art: mp3-k10
    flip: true
    body:
      - >-
        Max Payne 3 is not an open-world game. It is a linear story fought
        level by level, with no loading screens between cutscenes and play,
        and critics counted that linear design among its weak points. New to
        the series are a cover system, the Last Stand — with health gone and a
        painkiller in your pocket, you get a moment to shoot whoever hit you
        last — and shootdodges you can keep firing from after you land.
      - >-
  ...
  - id: multiplayer
    ...
    meta: Up to 16 players · console servers closed in 2021
    band: true
    body:
      - >-
        This was the first game in the series with online multiplayer: up to
        16 players in co-op or competitive modes, on maps rebuilt from the
        campaign, where the mode and the map can change during a match. Gang
        Wars plays four objective rounds that decide who has the edge in a
        final deathmatch, and players formed crews through Rockstar’s Social
        Club.
      - >-
  ...
  - id: reception
    ...
    meta: Metacritic — PC 87, PS3 87, Xbox 360 86
    body:
      - >-
...
cta:
  title: Playing on PC?
  lead: >-
    What Max Payne 3 needs, the Rockstar account and the graphics menu that
    counts your video memory — the PC page has the details.
  href: /pc/
