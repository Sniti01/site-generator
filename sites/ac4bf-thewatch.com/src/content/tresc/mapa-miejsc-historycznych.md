...
# akapit na rząd. Kadry (punkt 34, П44): dwa rzędy bez artu — dla Anglii
# wikingów i Grecji z Egiptem żaden z pięciu kluczy epok ani zdjęć Commons
# nie pasuje, więc idą kolumną; Paryż z Londynem dostają `foto-londyn`,
# Włochy z morzami — `foto-wlochy` (oba Commons, prawdziwe miasta — jak
# temat strony).
rows:
  - id: anglia-wikingow
    year: 872–878
