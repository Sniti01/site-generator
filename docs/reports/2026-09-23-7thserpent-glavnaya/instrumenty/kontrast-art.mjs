 ...
 *   лид героя 6,69; 1440×500 — 6,35), кроме телефонов в ландшафте шириной
 *   641–1024 (667×375, 844×390): там строки лида и приписки цитаты уходят
 *   под сгиб, и замер отказывает «срезана»/«вне кадра» — лид там стоит
 *   под полосой арта, на ночи;
 ...
 *   и градиентов, а на части ширин (1285, 900, 768, 1024) ещё и другой
 *   кандидат `srcset` (раунд 3, R3-KA-3); числа сдвигаются на десятые в обе
 *   стороны (критик
