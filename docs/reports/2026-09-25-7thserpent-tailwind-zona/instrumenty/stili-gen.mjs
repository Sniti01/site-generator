...
// инструкции проходит «несёт правила». Лист с чужого адреса (другой порт, внешний шрифт) без
// CORS (нет crossorigin у ссылки или Access-Control-Allow-Origin в ответе) даёт −1 правил
// и ложный отказ; с CORS правила читаются, и остановки нет. Разные сборки на портах «до» и «после» подтверждает ведущий
