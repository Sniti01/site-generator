...
// окон — 700–1180: окна ниже и выше в полосу не входят (замер их мерит,
// кроме окон, где строки уходят за нижний край, — телефоны в ландшафте любой
// ширины и низкие окна 641–1024 высотой до ~540px, там отказ; раунды 3–4,
// R3-KA-2, F2).
async (page) => {
