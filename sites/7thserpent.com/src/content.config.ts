    ...
    schema: z
      .object({
        ...
        /* — cta-band: полоса призыва, форма первого сайта (П89 п. 1 «Как прочитано»).
           ...
           может быть ещё не собрана (плановый адрес дерева законен). Какой хост
           у внешнего адреса, схема не судит. Арта у призыва маршрута нет
           (П89, слова владельца, п. 3). */
        cta: z
          .object({
            title: tekst(),
            lead: tekst(),
            href: z.string().regex(/^(?:\/(?![/\\])\S*|https:\/\/[^/\\\s]\S*)$/),
            label: tekst(),
          })
          .strict()
          .optional(),
